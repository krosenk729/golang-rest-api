...
const getDayNum = (m = 1) => m * 24 * 60 * 60 * 1000;
...
var Verbs;
(function (Verbs) {
    Verbs["created"] = "Created";
    Verbs["completed"] = "Completed";
    Verbs["initiative"] = "Took Initiative";
    Verbs["led"] = "Led";
    Verbs["participated"] = "Participated";
})(Verbs || (Verbs = {}));
...
app.component('tab-review', {
  ...
  `,
    ...
    async created() {
        ...
        const { tagsHash, verbHash } = this.data.reduce(({ tagsHash, verbHash }, { tags, verb }) => {
            tags.forEach((t) => {
